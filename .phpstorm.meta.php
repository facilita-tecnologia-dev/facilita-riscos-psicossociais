...
'components.modal.title','components.modal.wrapper','components.actions.button','components.actions.mobile-nav-item','components.actions.nav-item',
'components.circle-pulse','components.file-icon','components.form.input-binary','components.form.input-checkbox','components.form.input-color',
'components.form.input-date','components.form.input-datetime','components.form.input-file','components.form.input-number','components.form.input-photo',
'components.form.input-text','components.form.select','components.form.textarea','components.info-item','components.site.nav-item',
'components.structure.breadcrumbs','components.structure.page-header','components.table.index','components.table.tbody','components.table.td',
'components.table.th','components.table.thead','components.table.tr','components.pdf.cover','components.pdf.footer',
