    ...
    <x-structure.page-container>
        ...
        <x-structure.main-content-container>
            ...
            <x-structure.message>
                ...
                Resultados do risco de {{ trim($risk->name) }} divididos por setor.
            </x-structure.message>
            ...
            <div class="w-full grid items-start grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                @foreach ($departments as $department => $results)
                    <a href="{{ route('dashboard.psychosocial.list', ['risk' => $risk, 'department' => $department])}}" class="bg-white/25 rounded-md px-4 py-5 shadow-md">
                        <x-table>
