<form class="bg-secondary-background border-borders flex flex-col gap-4 rounded-lg border p-4 shadow-sm md:p-6" wire:submit.prevent="submit">
    <header class="flex items-center justify-between">
        ...
        <div class="cursor-pointer transition hover:scale-105" data-tippy-content="Abaixo, você pode editar as permissões deste usuário. Essa funcionalidade só fica disponível enquanto ele tiver o perfil de gestor. Caso o usuário seja funcionário, suas permissões se limitam apenas à realização dos testes das campanhas da empresa.">
            <x-icon icon="circle-question-mark" class="text-secondary-text h-5 w-5 object-contain" />
        </div>
    </header>

    <p class="text-sm sm:text-base text-main-text text-left font-normal">Abaixo, você pode editar as permissões deste gestor no sistema.</p>
