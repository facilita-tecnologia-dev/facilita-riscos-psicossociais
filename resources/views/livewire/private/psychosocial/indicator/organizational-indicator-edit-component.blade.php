<div class="contents">
    <form class="bg-secondary-background border-borders flex flex-col gap-4 rounded-lg border p-4 shadow-sm md:p-6" wire:submit.prevent="submit">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <x-form.input-number wireModel="reports" name="reports" label="{{ App\Enums\Psychosocial\Indicator::REPORTS->label() }}" :placeholder="'Digite a quantidade de ' . strtolower(App\Enums\Psychosocial\Indicator::REPORTS->label()) . ' na sua empresa nos últimos 12 meses...'"  tooltip="Quantidade total de denúncias nos últimos 12 meses." />
        </div>
