<section class="flex flex-col gap-6 p-4">
    ...
    <form class="bg-secondary-background border-borders flex flex-col gap-4 rounded-lg border p-4 shadow-sm md:p-6" wire:submit.prevent="submit">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 items-end">
            <x-new-components.form.input-text wireModel="registerName" name="registerName" label="Razão social" placeholder="Digite a razão social..." tooltip="Digite a razão social" isRequired />
            ...
            <x-new-components.form.input-text wireModel="cnpj" name="cnpj" label="CNPJ" placeholder="Digite o cnpj..." tooltip="Digite o cnpj" isRequired />

            <x-new-components.form.select wireModel="psychosocialMetodology" name="psychosocialMetodology" label="Metodologia de avaliação de Riscos" placeholder="Selecione a metodologia" tooltip="Selecione a metodologia de avaliação dos riscos psicossociais que será utilizada pela empresa" :options="$psychosocialMetodologies" isRequired />
            ...
            <x-new-components.form.input-text wireModel="passwordConfirmation" name="passwordConfirmation" label="Confirme a senha" placeholder="Confirme a senha..." tooltip="Confirme a senha que você criou" isRequired isPassword />
        </div>
