<section class="flex flex-col gap-6 p-4">
    ...
    <form class="bg-secondary-background border-borders flex flex-col gap-4 rounded-lg border p-4 shadow-sm md:p-6" wire:submit.prevent="submit">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start">
            ...
            <x-form.select wireModel="type" name="type" label="Tipo de usuário" placeholder="Selecione o tipo de usuário" tooltip="Selecione o tipo de usuário" :options="$userTypes" isRequired wireModelType="live" />
