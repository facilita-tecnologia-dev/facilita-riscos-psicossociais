<form class="flex w-full flex-col items-start gap-4" id="filter-companies" wire:submit.prevent="submit">
    <x-form.input-text wireModel="register_name" name="register_name" label="Razão Social" placeholder="Digite a razão social..." tooltip="Digite a razão social da empresa" />
    <x-form.input-text wireModel="cnpj" name="cnpj" label="CNPJ" placeholder="Digite o cnpj..." tooltip="Digite o cnpj da empresa" />

    <x-form.select wireModel="order_by" name="order_by" label="Ordenar por" placeholder="Selecione o tipo de ordenação" tooltip="Selecione o tipo de ordenação desejado" :options="$companyOrderTypes" />
