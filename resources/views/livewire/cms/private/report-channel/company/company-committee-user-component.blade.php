<a 
    ...
    <div class="space-y-2">
        <x-info-item label="Nome" value="{!! $user['full_name'] !!}" truncate />
        <x-info-item label="Setor" value="{!! $user['department_name'] !!}" truncate />
    </div>

    <x-actions.button wire:click='detachUser' class="!bg-danger">
