<div class="contents">
    @if($company['subscription_type'] !== App\Enums\ReportChannel\ReportChannelCompanySubscriptionTypes::SUBSCRIBED->value)
        <x-new-components.actions.button wire:click='turnAccessOn' class="!bg-report-channel-primary-solid" fitSize>
    ...
    @if($company['subscription_type'] === App\Enums\ReportChannel\ReportChannelCompanySubscriptionTypes::SUBSCRIBED->value)
        <x-new-components.actions.button wire:click='turnAccessOff' class="!bg-danger" fitSize>
