<x-layouts.auth>
    <livewire:auth.reset-password.user-reset-password-component email="{{ $email }}" token="{{ $token }}" />
</x-layouts.auth>
...
{{--
    ...
    <x-form action="{{ route('user.password.update') }}" class="flex w-full flex-col items-center gap-4" post>
