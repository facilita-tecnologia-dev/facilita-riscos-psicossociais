    ...
    private static function needsWeightedAverage(int $initialRating): bool
    {
        if($initialRating === 1){
            $indicators = [
                ...
                session('auth:company')->accidents() < 10,
            ];
        }
        ...
        if($initialRating === 2){
            $indicators = [
                ...
                session('auth:company')->accidents() >= 10 && session('auth:company')->accidents() < 25,
            ];
        }
        ...
        if($initialRating === 3){
            $indicators = [
                ...
                session('auth:company')->accidents() >= 25 && session('auth:company')->accidents() < 40,
            ];
        }
        ...
        if($initialRating === 4){
            $indicators = [
                ...
                session('auth:company')->accidents() > 40,
            ];
        }
